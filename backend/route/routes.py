...
from controller.root import login, ping, health_check,get_training_certifications, update_pr, get_reward, exchange_reward, icon, get_user_rewards, get_user_info, review_result, review_history, get_all_users
...
bp_root.route('/user_info', methods=['GET', 'POST'])(get_user_info)
bp_root.route('/review', methods=['POST'])(review_result)
bp_root.route('/review_history', methods=['GET','POST'])(review_history)
bp_root.route('/all_users', methods=['GET'])(get_all_users)